...
export const Footer = () => {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-48 sm:w-80 h-48 sm:h-80 bg-accent/5 rounded-full blur-3xl translate-y-1/2 -translate-x-1/2" />
        ...
        <div className="container px-4 py-8 sm:py-10 md:py-14">
          <div className="flex flex-col md:flex-row items-center justify-between gap-5 md:gap-10">
            <div className="text-center md:text-left">
              <div className="inline-flex items-center gap-2 px-3 py-1 bg-primary/10 rounded-full text-xs sm:text-sm font-medium text-primary mb-2 sm:mb-3">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className={`group relative w-11 h-11 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-xl sm:rounded-2xl bg-secondary/80 backdrop-blur-sm flex items-center justify-center text-muted-foreground transition-all duration-300 active:scale-95 hover:scale-105 ${social.bgHover} border border-border/50 hover:border-primary/30 touch-target`}
      ...
      <div className="relative container px-4 py-8 sm:py-10 md:py-14">
        <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-12">
          ...
          {/* Contact Info - Mobile friendly tappable areas */}
          <div className="col-span-2 md:col-span-1">
            ...
            <ul className="space-y-2 sm:space-y-3">
              ...
              <li className="flex items-center gap-3 text-muted-foreground text-sm py-1.5">
                <div className="h-9 w-9 sm:h-10 sm:w-10 rounded-xl bg-secondary flex items-center justify-center flex-shrink-0">
